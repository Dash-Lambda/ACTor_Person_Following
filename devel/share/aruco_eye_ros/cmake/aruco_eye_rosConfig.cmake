...
if("TRUE" STREQUAL "TRUE")
  set(aruco_eye_ros_SOURCE_PREFIX /home/actor1/ACTor_Person_Following/src/aruco_eye/aruco_eye_ros)
  set(aruco_eye_ros_DEVEL_PREFIX /home/actor1/ACTor_Person_Following/devel)
  ...
  set(aruco_eye_ros_INSTALL_PREFIX /home/actor1/ACTor_Person_Following/install)
...
if(NOT "/home/actor1/ACTor_Person_Following/src/aruco_eye/aruco_eye_ros/src/include;/usr/include/opencv4 " STREQUAL " ")
  set(aruco_eye_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/actor1/ACTor_Person_Following/src/aruco_eye/aruco_eye_ros/src/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_eye_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/actor1/ACTor_Person_Following/src/aruco_eye/aruco_eye_ros/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;message_filters;image_transport;cv_bridge;geometry_msgs;tf2;tf2_geometry_msgs;tf2_ros;perception_msgs;robot_component_srvs;aruco_eye_core")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(aruco_eye_ros_EXPORTED_TARGETS ${${aruco_eye_ros_dep}_EXPORTED_TARGETS})
endforeach()
