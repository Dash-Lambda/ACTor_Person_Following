...
if("TRUE" STREQUAL "TRUE")
  set(pugixml_SOURCE_PREFIX /home/actor1/ACTor_Person_Following/src/pugixml)
  set(pugixml_DEVEL_PREFIX /home/actor1/ACTor_Person_Following/devel)
  set(pugixml_INSTALL_PREFIX "")
  set(pugixml_PREFIX ${pugixml_DEVEL_PREFIX})
else()
  set(pugixml_SOURCE_PREFIX "")
  set(pugixml_DEVEL_PREFIX "")
  set(pugixml_INSTALL_PREFIX /home/actor1/ACTor_Person_Following/install)
...
if(NOT "/home/actor1/ACTor_Person_Following/src/pugixml/src/include " STREQUAL " ")
  set(pugixml_INCLUDE_DIRS "")
  set(_include_dirs "/home/actor1/ACTor_Person_Following/src/pugixml/src/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pugixml' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/actor1/ACTor_Person_Following/src/pugixml/${idir}'.  ${_report}")
    endif()
