...
class SteeringReport {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.steering_wheel_cmd_type = null;
      this.speed = null;
      this.enabled = null;
      this.override = null;
      this.timeout = null;
      ...
      if (initObj.hasOwnProperty('steering_wheel_cmd_type')) {
        this.steering_wheel_cmd_type = initObj.steering_wheel_cmd_type
      }
      else {
        this.steering_wheel_cmd_type = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.steering_wheel_cmd, buffer, bufferOffset);
    ...
    // Serialize message field [steering_wheel_cmd_type]
    bufferOffset = _serializer.uint8(obj.steering_wheel_cmd_type, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.steering_wheel_cmd = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [steering_wheel_torque]
    data.steering_wheel_torque = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [steering_wheel_cmd_type]
    data.steering_wheel_cmd_type = _deserializer.uint8(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'dbw_polaris_msgs/SteeringReport';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'd69c596b4b3137253a040eceaaa57690';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.steering_wheel_cmd_type !== undefined) {
      resolved.steering_wheel_cmd_type = msg.steering_wheel_cmd_type;
    }
    else {
      resolved.steering_wheel_cmd_type = 0
    }
