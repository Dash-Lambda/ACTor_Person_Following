...
(cl:defmethod cl:initialize-instance :after ((m <WatchdogCounter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WatchdogCounter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_polaris_msgs-msg:<WatchdogCounter> is deprecated: use dbw_polaris_msgs-msg:WatchdogCounter instead.")))

(cl:ensure-generic-function 'source-val :lambda-list '(m))
(cl:defmethod source-val ((m <WatchdogCounter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:source-val is deprecated.  Use dbw_polaris_msgs-msg:source instead.")
  (source m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WatchdogCounter>)))
  ...
  "dbw_polaris_msgs/WatchdogCounter")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WatchdogCounter)))
  "Returns string type for a message object of type 'WatchdogCounter"
  "dbw_polaris_msgs/WatchdogCounter")
