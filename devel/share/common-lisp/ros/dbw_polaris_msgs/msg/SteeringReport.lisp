...
(cl:defclass <SteeringReport> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (steering_wheel_cmd_type
    :reader steering_wheel_cmd_type
    :initarg :steering_wheel_cmd_type
    :type cl:fixnum
    :initform 0)
   (speed
    :reader speed
...
(cl:defmethod cl:initialize-instance :after ((m <SteeringReport>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SteeringReport)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_polaris_msgs-msg:<SteeringReport> is deprecated: use dbw_polaris_msgs-msg:SteeringReport instead.")))
...
(cl:defmethod steering_wheel_angle-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:steering_wheel_angle-val is deprecated.  Use dbw_polaris_msgs-msg:steering_wheel_angle instead.")
  (steering_wheel_angle m))

(cl:ensure-generic-function 'steering_wheel_cmd-val :lambda-list '(m))
(cl:defmethod steering_wheel_cmd-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:steering_wheel_cmd-val is deprecated.  Use dbw_polaris_msgs-msg:steering_wheel_cmd instead.")
...
(cl:defmethod steering_wheel_torque-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:steering_wheel_torque-val is deprecated.  Use dbw_polaris_msgs-msg:steering_wheel_torque instead.")
  (steering_wheel_torque m))

(cl:ensure-generic-function 'steering_wheel_cmd_type-val :lambda-list '(m))
(cl:defmethod steering_wheel_cmd_type-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:steering_wheel_cmd_type-val is deprecated.  Use dbw_polaris_msgs-msg:steering_wheel_cmd_type instead.")
  (steering_wheel_cmd_type m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:speed-val is deprecated.  Use dbw_polaris_msgs-msg:speed instead.")
  (speed m))
...
(cl:defmethod fault_bus1-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:fault_bus1-val is deprecated.  Use dbw_polaris_msgs-msg:fault_bus1 instead.")
  (fault_bus1 m))

(cl:ensure-generic-function 'fault_bus2-val :lambda-list '(m))
(cl:defmethod fault_bus2-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:fault_bus2-val is deprecated.  Use dbw_polaris_msgs-msg:fault_bus2 instead.")
  (fault_bus2 m))

(cl:ensure-generic-function 'fault_calibration-val :lambda-list '(m))
(cl:defmethod fault_calibration-val ((m <SteeringReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_polaris_msgs-msg:fault_calibration-val is deprecated.  Use dbw_polaris_msgs-msg:fault_calibration instead.")
  (fault_calibration m))
...
(cl:defmethod fault_power-val ((m <SteeringReport>))
  ...
  (fault_power m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<SteeringReport>)))
    "Constants for message type '<SteeringReport>"
  '((:CMD_ANGLE . 0)
    (:CMD_TORQUE . 1))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'SteeringReport)))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SteeringReport>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'steering_wheel_cmd))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'steering_wheel_torque))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'steering_wheel_cmd_type)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SteeringReport>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'steering_wheel_cmd) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'steering_wheel_cmd_type)) (cl:read-byte istream))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SteeringReport>)))
  ...
  "dbw_polaris_msgs/SteeringReport")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SteeringReport)))
  "Returns string type for a message object of type 'SteeringReport"
  "dbw_polaris_msgs/SteeringReport")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SteeringReport>)))
  ...
  "d69c596b4b3137253a040eceaaa57690")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SteeringReport)))
  "Returns md5sum for a message object of type 'SteeringReport"
  "d69c596b4b3137253a040eceaaa57690")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SteeringReport>))
  ...
  (cl:list 'SteeringReport
    ...
    (cl:cons ':steering_wheel_cmd_type (steering_wheel_cmd_type msg))
