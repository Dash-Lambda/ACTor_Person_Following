...
(cl:in-package robot_component_srvs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_component_srvs-srv:<SetBool-request> is deprecated: use robot_component_srvs-srv:SetBool-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetBool-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_component_srvs-srv:data-val is deprecated.  Use robot_component_srvs-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBool-request>)))
  ...
  "robot_component_srvs/SetBoolRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBool-request)))
  "Returns string type for a service object of type 'SetBool-request"
  "robot_component_srvs/SetBoolRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_component_srvs-srv:<SetBool-response> is deprecated: use robot_component_srvs-srv:SetBool-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_component_srvs-srv:success-val is deprecated.  Use robot_component_srvs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_component_srvs-srv:message-val is deprecated.  Use robot_component_srvs-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBool-response>)))
  ...
  "robot_component_srvs/SetBoolResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBool-response)))
  "Returns string type for a service object of type 'SetBool-response"
  "robot_component_srvs/SetBoolResponse")
