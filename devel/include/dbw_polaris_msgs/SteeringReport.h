// Generated by gencpp from file dbw_polaris_msgs/SteeringReport.msg
// DO NOT EDIT!


#ifndef DBW_POLARIS_MSGS_MESSAGE_STEERINGREPORT_H
#define DBW_POLARIS_MSGS_MESSAGE_STEERINGREPORT_H
...
struct SteeringReport_
{
  ...
  _steering_wheel_angle_type steering_wheel_angle;
   ...
   typedef float _steering_wheel_cmd_type;
  ...
  _steering_wheel_torque_type steering_wheel_torque;
   ...
   typedef uint8_t _steering_wheel_cmd_type_type;
  _steering_wheel_cmd_type_type steering_wheel_cmd_type;
  ...
  typedef boost::shared_ptr< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> const> ConstPtr;

}; // struct SteeringReport_

typedef ::dbw_polaris_msgs::SteeringReport_<std::allocator<void> > SteeringReport;

typedef boost::shared_ptr< ::dbw_polaris_msgs::SteeringReport > SteeringReportPtr;
typedef boost::shared_ptr< ::dbw_polaris_msgs::SteeringReport const> SteeringReportConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xd69c596b4b313725ULL;
  static const uint64_t static_value2 = 0x3a040eceaaa57690ULL;
};

template<class ContainerAllocator>
struct DataType< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.steering_wheel_cmd_type);
      stream.next(m.speed);
...
template<class ContainerAllocator>
struct Printer< ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_polaris_msgs::SteeringReport_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    Printer<float>::stream(s, indent + "  ", v.steering_wheel_cmd);
    s << indent << "steering_wheel_torque: ";
    Printer<float>::stream(s, indent + "  ", v.steering_wheel_torque);
    s << indent << "steering_wheel_cmd_type: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.steering_wheel_cmd_type);
    s << indent << "speed: ";
...
#endif // DBW_POLARIS_MSGS_MESSAGE_STEERINGREPORT_H
