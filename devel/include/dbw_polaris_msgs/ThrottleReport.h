// Generated by gencpp from file dbw_polaris_msgs/ThrottleReport.msg
// DO NOT EDIT!


#ifndef DBW_POLARIS_MSGS_MESSAGE_THROTTLEREPORT_H
#define DBW_POLARIS_MSGS_MESSAGE_THROTTLEREPORT_H
...
struct ThrottleReport_
{
  ...
  typedef boost::shared_ptr< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> const> ConstPtr;

}; // struct ThrottleReport_

typedef ::dbw_polaris_msgs::ThrottleReport_<std::allocator<void> > ThrottleReport;

typedef boost::shared_ptr< ::dbw_polaris_msgs::ThrottleReport > ThrottleReportPtr;
typedef boost::shared_ptr< ::dbw_polaris_msgs::ThrottleReport const> ThrottleReportConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_polaris_msgs::ThrottleReport_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DBW_POLARIS_MSGS_MESSAGE_THROTTLEREPORT_H
