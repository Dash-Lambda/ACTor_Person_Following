// Generated by gencpp from file dbw_polaris_msgs/WatchdogCounter.msg
// DO NOT EDIT!


#ifndef DBW_POLARIS_MSGS_MESSAGE_WATCHDOGCOUNTER_H
#define DBW_POLARIS_MSGS_MESSAGE_WATCHDOGCOUNTER_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> const> ConstPtr;

}; // struct WatchdogCounter_

typedef ::dbw_polaris_msgs::WatchdogCounter_<std::allocator<void> > WatchdogCounter;

typedef boost::shared_ptr< ::dbw_polaris_msgs::WatchdogCounter > WatchdogCounterPtr;
typedef boost::shared_ptr< ::dbw_polaris_msgs::WatchdogCounter const> WatchdogCounterConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint8 source\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_polaris_msgs::WatchdogCounter_<ContainerAllocator>& v)
  {
    s << indent << "source: ";
...
#endif // DBW_POLARIS_MSGS_MESSAGE_WATCHDOGCOUNTER_H
