...
"""autogenerated by genpy from dbw_polaris_msgs/BrakeReport.msg. Do not edit."""
import codecs
import sys
...
import dbw_polaris_msgs.msg
import std_msgs.msg

class BrakeReport(genpy.Message):
  _md5sum = "8fcdb23643ffb06de372fe999ba6e238"
  _type = "dbw_polaris_msgs/BrakeReport"
...
"""
  __slots__ = ['header','torque_input','torque_cmd','torque_output','enabled','override','driver','timeout','watchdog_counter','watchdog_braking','fault_wdc','fault_ch1','fault_ch2','fault_power']
  _slot_types = ['std_msgs/Header','float32','float32','float32','bool','bool','bool','bool','dbw_polaris_msgs/WatchdogCounter','bool','bool','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,torque_input,torque_cmd,torque_output,enabled,override,driver,timeout,watchdog_counter,watchdog_braking,fault_wdc,fault_ch1,fault_ch2,fault_power
    ...
    if args or kwds:
      ...
      if self.watchdog_counter is None:
        self.watchdog_counter = dbw_polaris_msgs.msg.WatchdogCounter()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3f10B().pack(_x.torque_input, _x.torque_cmd, _x.torque_output, _x.enabled, _x.override, _x.driver, _x.timeout, _x.watchdog_counter.source, _x.watchdog_braking, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_power))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.torque_input, _x.torque_cmd, _x.torque_output, _x.enabled, _x.override, _x.driver, _x.timeout, _x.watchdog_counter.source, _x.watchdog_braking, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_power,) = _get_struct_3f10B().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_3f10B = None
def _get_struct_3f10B():
    global _struct_3f10B
    if _struct_3f10B is None:
        _struct_3f10B = struct.Struct("<3f10B")
    return _struct_3f10B
