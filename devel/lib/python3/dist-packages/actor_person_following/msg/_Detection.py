...
class Detection(genpy.Message):
  _md5sum = "83582f4681826792410c545e6580f1c0"
...
float64 frame_y
"""
  __slots__ = ['width','height','center','close_overlap','aruco_overlap','close_dist','aruco_dist','aruco_strength','r','g','b','gesture','pose_points','box','lidar_point']
  _slot_types = ['float64','float64','float64','float64','float64','float64','float64','float64','float32','float32','float32','string','actor_person_following/Pose_Points','darknet_ros_msgs/BoundingBox','actor_person_following/Lidar_Point']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       width,height,center,close_overlap,aruco_overlap,close_dist,aruco_dist,aruco_strength,r,g,b,gesture,pose_points,box,lidar_point
    ...
    if args or kwds:
      ...
      if self.pose_points is None:
        self.pose_points = actor_person_following.msg.Pose_Points()
      if self.box is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.pose_points.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.pose_points.points:
        _x = val1
        buff.write(_get_struct_2d2i().pack(_x.x, _x.y, _x.frame_x, _x.frame_y))
      _x = self
      buff.write(_get_struct_d4qh().pack(_x.box.probability, _x.box.xmin, _x.box.ymin, _x.box.xmax, _x.box.ymax, _x.box.id))
      _x = self.box.Class
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.pose_points.points = []
      for i in range(0, length):
        val1 = actor_person_following.msg.Pose_Point()
        _x = val1
        start = end
        end += 24
        (_x.x, _x.y, _x.frame_x, _x.frame_y,) = _get_struct_2d2i().unpack(str[start:end])
        self.pose_points.points.append(val1)
      _x = self
      start = end
      end += 42
      (_x.box.probability, _x.box.xmin, _x.box.ymin, _x.box.xmax, _x.box.ymax, _x.box.id,) = _get_struct_d4qh().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
